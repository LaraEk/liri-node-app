# liri-node-app
GW Coding Bootcamp Assignment to create a command line node app that takes in parameters and returns data.  Makes use of Spotify API, Twitter API, and Node. Jul 21, 2018
